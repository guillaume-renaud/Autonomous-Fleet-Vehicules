...
public class ButtonRequestController implements ActionListener {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				else if (button.getText().equals("Random Request"))
				{
					...
					if( button.rf.mainBox.passengers.indexOf(p) == button.rf.mainBox.commandControl.treatedRequest && button.rf.mainBox.commandControl.nbCarInMission == 1 )
					{
					...
					}else if( button.rf.mainBox.passengers.indexOf(p) == button.rf.mainBox.commandControl.treatedRequest && button.rf.mainBox.commandControl.nbCarInMission == 0  )
					{
						MailBoxEvent event = new MailBoxEvent (p.getClass().getName(), button.rf.mainBox.passengers.indexOf(p), "NEW_REQUEST");
